...
🔹 В вебе достаточно давно(уже лет 10), и бывал на разных должностях таких как (`копирайтер, дизайнер, фулстек`) и остановился на фронте, так как сильно понравилась причудливость `JS`, и есть больше тяги работать с интерфейсами. 

🔹 Больше всего люблю реализовывать комплексные решения делать сервисы под ключ, но в силу того что фулстек не позволяет детально погрузится в каждую отрасль, где-то постоянно всплывают не доработки, по этому решил уйти глубже в фронт

🔹 Проектов повидал достаточно много, может вас интересует опыт в какой-то конкретной отрасли?

&emsp;&emsp; 🎯 Я реализовал ряд классных комплексных решений как в фулстек команде, так и самостоятельно под ключ  

&emsp;&emsp; 🎯 Так же достаточно поработал фронтом, в более крупных и специализированных командах.

&emsp;&emsp; 🎯 Так же могу рассказать немного об минимальной `OpenSource` деятельности или `soft` скилах.
