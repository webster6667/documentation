...
🔹 `Stage for commit`  
&emsp;&emsp; 👆 Либо `Untracked` добавленный в `WorkDirectory`, либо файл уже лежащий в репозитории, но измененный
...
🔹 `--keep`  
&emsp;&emsp; 👆 Откатываемся на указанный коммит, не цепляя с собой закомиченные данные из уходящего комита, но сохраняет и переводит в `workDirectory но не добавленно в stage area` не закомиченные изменения
