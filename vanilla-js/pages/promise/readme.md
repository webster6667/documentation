...
&emsp;&emsp; 🔹 Не дожидаеться выполнения таймаутов      
...
&emsp;&emsp;&emsp;&emsp; 🛑 `throw new Error` не будет обработан если вызывается из асинхронной опреации`(timeout)`, `reject` будет    
