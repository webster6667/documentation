...
💠 **configurable** = `false`     
👆🏽 Можно ли удалить свойство и изменить у него флаги дескриптора при помощи `Object.defineProperty/s` 

<br><br>
    
🛑 При создании объекта через `Object.create`, `Object.defineProperty/s`, по дефолту все равны `false`      
&emsp;&emsp; 🎯 `get/set` и `[writable, enumerable, configurable]` Взаимо исключающие   
&emsp;&emsp;&emsp;&emsp; 👆 Должно быть что-то одно, `get/set` или `[writable, enumerable, configurable]`  
