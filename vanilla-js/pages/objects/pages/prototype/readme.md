...
&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; 🎯 Если в код попал экземпляр объекта, созданный при помощи функции конструктора

&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; 🎯 И необходимо создать похожий объект, но доступа к функции конструктору нет
